...
function getData() {
        ...
        console.log("heyy");
    // var b = document.getElementById('tree-container');
    // b.remove();
    // var h = document.getElementsByTagName('body')[0];
    // var to_append = '<div id="tree-container"></div>';
    // h.innerHTML = to_append;
    ...
    treeJSON = d3.json("{{ url_for('static', filename='after.json')}}" + "?_=" + noCache, function (error, treeData) {
        if (error) throw error; 
    // treeJSON = d3.json("./after.json", function (error, treeData) {
    //     if (error) throw error;
